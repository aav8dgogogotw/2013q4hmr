...
<div class="Content Recipe03Block SameBlock">
    <div class="Warpper">
        <div class="TabBlock">
                <ul>
                    ...
                    <li class="Tab03"><a href="javascript: recipe03();" title="蝦仁炒飯米蛋糕" href="?page=recipe03"  class="Active">蝦仁炒飯米蛋糕</a></li>
            ...
            <div class="RecipeBox"> 
            <a href="javascript: recipe03Form();" title="蝦仁炒飯米蛋糕" class="LinkGoRecipe">蝦仁炒飯米蛋糕</a>             
